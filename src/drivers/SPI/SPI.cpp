...
bool SPI::bindSSEL(const Gpio &SSEL, uint8_t &bindedSSEL) {
    if (this->m_SPI == SPI0) {
    	...
    	if (this->m_SPI0_SSELs < 2 && ((SWM0->PINASSIGN.PINASSIGN4 & (0xFF << (!(this->m_SPI0_SSELs) ? 16 : 24))) >> (!(this->m_SPI0_SSELs) ? 16 : 24)) != 0xFF) return false;
    	else if (this->m_SPI0_SSELs >= 2 && ((SWM0->PINASSIGN.PINASSIGN5 & (0xFF << (!(this->m_SPI0_SSELs - 2) ? 0 : 8))) >> (!(this->m_SPI0_SSELs - 2) ? 0 : 8)) != 0xFF) return false;
    	SYSCON->SYSAHBCLKCTRL0 |= SYSCON_SYSAHBCLKCTRL0_SWM_MASK;
		if (this->m_SPI0_SSELs < 2) SWM0->PINASSIGN.PINASSIGN4 &= (((SSEL.getBit() + SSEL.getPort() * 0x20) << (!(this->m_SPI0_SSELs) ? 16 : 24)) | ~(0xFF << (!(this->m_SPI0_SSELs) ? 16 : 24)));
		else SWM0->PINASSIGN.PINASSIGN5 &= (((SSEL.getBit() + SSEL.getPort() * 0x20) << (!(this->m_SPI0_SSELs - 2) ? 0 : 8)) | ~(0xFF << (!(this->m_SPI0_SSELs - 2) ? 0 : 8)));
		SYSCON->SYSAHBCLKCTRL0 &= ~SYSCON_SYSAHBCLKCTRL0_SWM_MASK;
		bindedSSEL = this->m_SPI0_SSELs++;
		this->m_bindSSELs++;
	} else if (this->m_SPI == SPI1) {
    	if (this->m_SPI1_SSELs > SPI1_MAX_SSEL - 1) return false;
    	if (((SWM0->PINASSIGN.PINASSIGN6 & (0xFF << (!(this->m_SPI1_SSELs) ? 8 : 16))) >> (!(this->m_SPI1_SSELs) ? 8 : 16)) != 0xFF) return false;
		SYSCON->SYSAHBCLKCTRL0 |= SYSCON_SYSAHBCLKCTRL0_SWM_MASK;
		SWM0->PINASSIGN.PINASSIGN6 &= (((SSEL.getBit() + SSEL.getPort() * 0x20) << (!(this->m_SPI1_SSELs) ? 8 : 16)) | ~(0xFF << (!(this->m_SPI1_SSELs) ? 8 : 16)));
		SYSCON->SYSAHBCLKCTRL0 &= ~SYSCON_SYSAHBCLKCTRL0_SWM_MASK;
...
bool SPI::unbindSSEL(uint8_t unbindedSSEL) {
    if (this->m_SPI == SPI0) {
    	...
    	if (unbindedSSEL < 2 && ((SWM0->PINASSIGN.PINASSIGN4 & (0xFF << (!unbindedSSEL ? 16 : 24))) >> (!unbindedSSEL ? 16 : 24)) == 0xFF) return false;
		else if (unbindedSSEL >= 2 && ((SWM0->PINASSIGN.PINASSIGN5 & (0xFF << (!(unbindedSSEL - 2) ? 0 : 8))) >> (!(unbindedSSEL - 2) ? 0 : 8)) == 0xFF) return false;
		SYSCON->SYSAHBCLKCTRL0 |= SYSCON_SYSAHBCLKCTRL0_SWM_MASK;
		if (unbindedSSEL < 2) SWM0->PINASSIGN.PINASSIGN4 |= (0xFF << (!unbindedSSEL ? 16 : 24));
		else SWM0->PINASSIGN.PINASSIGN5 |= (0xFF << (!(unbindedSSEL - 2) ? 0 : 8));
		SYSCON->SYSAHBCLKCTRL0 &= ~SYSCON_SYSAHBCLKCTRL0_SWM_MASK;
		this->m_SPI0_SSELs--;
		this->m_bindSSELs--;
	} else if (this->m_SPI == SPI1) {
    	if (!(this->m_SPI1_SSELs)) return false;
    	if (((SWM0->PINASSIGN.PINASSIGN6 & (0xFF << (!unbindedSSEL ? 8 : 16))) >> (!unbindedSSEL ? 8 : 16)) == 0xFF) return false;
    	SYSCON->SYSAHBCLKCTRL0 |= SYSCON_SYSAHBCLKCTRL0_SWM_MASK;
		SWM0->PINASSIGN.PINASSIGN6 |= (0xFF << (!unbindedSSEL ? 8 : 16));
		SYSCON->SYSAHBCLKCTRL0 &= ~SYSCON_SYSAHBCLKCTRL0_SWM_MASK;
    	this->m_SPI1_SSELs--;
    	this->m_bindSSELs--;
	}
